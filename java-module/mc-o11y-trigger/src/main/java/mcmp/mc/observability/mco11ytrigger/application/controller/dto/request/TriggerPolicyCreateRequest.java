...
@Builder
public record TriggerPolicyCreateRequest(String title, String description, ThresholdCondition thresholdCondition,
		ResourceType resourceType, AggregationType aggregationType, String holdDuration, String repeatInterval) {
}
