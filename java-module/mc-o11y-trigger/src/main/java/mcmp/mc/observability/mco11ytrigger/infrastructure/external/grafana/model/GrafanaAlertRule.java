...
public class GrafanaAlertRule {
	...
	@Builder
	public GrafanaAlertRule(Integer id, String uid, Integer orgId, String folderUid, String ruleGroup, String title,
			String condition, List<GrafanaAlertQuery> data, String updated, String noDataState, String execErrState,
			String duration, Map<String, String> annotations, Map<String, String> labels, String provenance,
			boolean isPaused, GrafanaNotificationSetting notificationSettings, GrafanaRecord record) {
		this.id = id;
		this.uid = uid;
		this.orgId = orgId;
