...
public class TriggerService {
	...
	public TriggerService(TriggerPolicyRepository triggerPolicyRepository,
			TriggerPolicySnapshotRepository triggerPolicySnapshotRepository, TriggerRepository triggerRepository,
	...
	public long createTrigger(long id, TriggerCreateDto triggerCreateDto) {
		...
		TriggerPolicySnapshot triggerPolicySnapshot = triggerPolicySnapshotRepository
				.findByTriggerPolicyIdAndVersion(triggerPolicy.getId(), triggerPolicy.getVersion());
		if (triggerPolicySnapshot == null) {
			triggerPolicySnapshot = triggerPolicySnapshotRepository.save(TriggerPolicySnapshot.create(triggerPolicy));
		}
